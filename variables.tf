...
variable "aro_master_node_count" {
  type        		= number
  default     		= 1
  description 		= "The ARO Master nodes count (Default is 1)"
}
...
variable "akv_pull_secret" {
  description 		= "Name of the key vault secret holding Azure Red Hat OpenShift pull-secret"
}
